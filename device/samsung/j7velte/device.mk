# Minimal device makefile for Samsung Galaxy J7 Neo (j7velte) - Halium 9.0
...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.vulkan.level-1.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.hardware.vulkan.level-1.xml \
    frameworks/native/data/etc/android.hardware.vulkan.version-1_1_0.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.hardware.vulkan.version-1_1_0.xml \
